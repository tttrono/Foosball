...
/** Draws the playing rod with 1 stick players for blue team. */
public class BlueTeam_Rod_1 implements DrawingObject {
	
	ArrayList<DrawingObject> Rod_1;
	private double y;

	public BlueTeam_Rod_1() {//initializes the rod with 1 stick players and sets their coordinates and color
